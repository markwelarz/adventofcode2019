...
public class Day14Test
{
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(stringResource("10 ORE => 10 A\n"
						+ "1 ORE => 1 B\n"
						+ "7 A, 1 B => 1 C\n"
						+ "7 A, 1 C => 1 D\n"
						+ "7 A, 1 D => 1 E\n"
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(stringResource("9 ORE => 2 A\n"
						+ "8 ORE => 3 B\n"
						+ "7 ORE => 5 C\n"
						+ "3 A, 4 B => 1 AB\n"
						+ "5 B, 7 C => 1 BC\n"
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(stringResource("157 ORE => 5 NZVS\n"
						+ "165 ORE => 6 DCFZ\n"
	...
	{
		Day14 day14 = new Day14();
		int amount = day14.calculatePart2(stringResource("157 ORE => 5 NZVS\n"
						+ "165 ORE => 6 DCFZ\n"
						+ "44 XJWVT, 5 KHKGT, 1 QDVJ, 29 NZVS, 9 GPVTF, 48 HKGWZ => 1 FUEL\n"
						+ "12 HKGWZ, 1 GPVTF, 8 PSHF => 9 QDVJ\n"
						+ "179 ORE => 7 PSHF\n"
						...
						+ "165 ORE => 2 GPVTF\n"
						+ "3 DCFZ, 7 NZVS, 5 HKGWZ, 10 PSHF => 8 KHKGT"));
		assertThat(amount).isEqualTo(82892753);
	}
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(stringResource("2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG\n"
	...
	@Test
	public void part2Example4() throws Exception
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart2(stringResource("2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG\n"
						+ "17 NVRVD, 3 JNWZP => 8 VPVL\n"
						+ "53 STKFG, 6 MNCFX, 46 VJHF, 81 HVMC, 68 CXFTF, 25 GNMV => 1 FUEL\n"
						+ "22 VJHF, 37 MNCFX => 5 FWMGM\n"
						+ "139 ORE => 4 NVRVD\n"
						...
						+ "1 VJHF, 6 MNCFX => 4 RFSQX\n"
						+ "176 ORE => 6 VJHF"));
		assertThat(amount).isEqualTo(5586022);
	}
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(stringResource("171 ORE => 8 CNZTR\n"
	...
	@Test
	public void part2Example5() throws Exception
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart2(stringResource("171 ORE => 8 CNZTR\n"
						+ "7 ZLQW, 3 BMBT, 9 XCVML, 26 XMNCP, 1 WPTQ, 2 MZWV, 1 RJRHP => 4 PLWSL\n"
						+ "114 ORE => 4 BHXH\n"
						+ "14 VRPVC => 6 BMBT\n"
						+ "6 BHXH, 18 KTJDG, 12 WPTQ, 7 PLWSL, 31 FHTLT, 37 ZDVW => 1 FUEL\n"
						...
						+ "7 XCVML => 6 RJRHP\n"
						+ "5 BHXH, 4 VRPVC => 5 LTCX"));
		assertThat(amount).isEqualTo(460664);
	}
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart1(new ClassPathResource("advent/day14input.txt"));
		assertThat(amount).isEqualTo(1582325);
	}
	...
	{
		Day14 day14 = new Day14();
		long amount = day14.calculatePart2(new ClassPathResource("advent/day14input.txt"));
		assertThat(amount).isEqualTo(2267486);
	}
